...
- Updated to [PocketBase v0.40.3](https://github.com/pocketbase/pocketbase/releases/tag/v0.40.3).
...
- Updated to [PocketBase v0.40.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.40.0).


## v3.4.64

- Updated to [PocketBase v0.39.11](https://github.com/pocketbase/pocketbase/releases/tag/v0.39.11).


## v3.4.63

- Updated to [PocketBase v0.39.10](https://github.com/pocketbase/pocketbase/releases/tag/v0.39.10).
...
- Updated to [PocketBase v0.39.4](https://github.com/pocketbase/pocketbase/releases/tag/v0.39.4).
...
- Updated to [PocketBase v0.39.1](https://github.com/pocketbase/pocketbase/releases/tag/v0.39.1).


## v3.4.53

- Updated to [PocketBase v0.39.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.39.0).


## v3.4.52

- Updated to [PocketBase v0.38.2](https://github.com/pocketbase/pocketbase/releases/tag/v0.38.2).


## v3.4.51

- Updated to [PocketBase v0.38.1](https://github.com/pocketbase/pocketbase/releases/tag/v0.38.1).


## v3.4.50

- Updated to [PocketBase v0.38.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.38.0).


## v3.4.49

- Updated to [PocketBase v0.37.5](https://github.com/pocketbase/pocketbase/releases/tag/v0.37.5).


## v3.4.48

- Updated to [PocketBase v0.37.4](https://github.com/pocketbase/pocketbase/releases/tag/v0.37.4).


## v3.4.47

- Updated to [PocketBase v0.37.3](https://github.com/pocketbase/pocketbase/releases/tag/v0.37.3).


## v3.4.46

- Updated to [PocketBase v0.37.2](https://github.com/pocketbase/pocketbase/releases/tag/v0.37.2).


## v3.4.45

- Updated to [PocketBase v0.37.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.37.0).


## v3.4.44

- Updated to [PocketBase v0.36.9](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.9).


## v3.4.43

- Updated to [PocketBase v0.36.8](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.8).


## v3.4.42

- Updated to [PocketBase v0.36.7](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.7).
...
- Updated to [PocketBase v0.36.4](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.4).


## v3.4.38

- Updated to [PocketBase v0.36.3](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.3).


## v3.4.37

- Updated [JS SDK to v0.26.8](https://github.com/pocketbase/js-sdk/releases/tag/v0.26.8).
- Updated to [PocketBase v0.36.2](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.2).


## v3.4.36

- Updated to [PocketBase v0.36.1](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.1).


## v3.4.35

- Updated to [PocketBase v0.36.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.36.0).


## v3.4.34

- Updated to [PocketBase v0.35.1](https://github.com/pocketbase/pocketbase/releases/tag/v0.35.1).
...
- Updated to [PocketBase v0.34.1](https://github.com/pocketbase/pocketbase/releases/tag/v0.34.1).


## v3.4.30

- Updated to [PocketBase v0.34.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.34.0).


## v3.4.29

- Updated to [PocketBase v0.33.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.33.0).


## v3.4.28

- Updated to [PocketBase v0.32.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.32.0).


## v3.4.27

- Updated to [PocketBase v0.31.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.31.0).
...
- Updated to [PocketBase v0.30.0](https://github.com/pocketbase/pocketbase/releases/tag/v0.30.0).


## v3.4.23

- Updated to [PocketBase v0.29.3](https://github.com/pocketbase/pocketbase/releases/tag/v0.29.3).


## v3.4.22

- Updated to [PocketBase v0.29.2](https://github.com/pocketbase/pocketbase/releases/tag/v0.29.2).
